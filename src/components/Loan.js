...
class Loan extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            finance_providers: [
                { provider: 'ICICI', address:'0x1416c4557DB0A9B1084f393439DeB36e984553aE', interest_rate: 20},
                { provider: 'SBI', address:'0xC54286487e31283702Fd3DFf58876152F9C8448c', interest_rate: 12}
            ]
        }
    }
    ...
    render() {
        return (
            ...
            <div className="container m-3 p-3">
                <div className="flex w-screen h-screen justify-center text-center tfw">
                    <h4>Loan Form</h4>
                    {/* <hr></hr> */}
                    <div className="res">
                        <br></br>
                    {/* <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"> */}
                        ...
                        <br></br>
                        {/* <hr></hr> */}
                        <p>Amount to repay: {this.state.loan_form.loan_amt *((100+this.state.loan_form.interest_rate)/100)} ETH</p>
                    </div>
                </div>
            </div>
            </>
